...
def build_workspace_state() -> WorkspaceState:
    ...
    floors = [
        FloorRecord(
            ...
            blueprint_image="https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=1000&q=80",
            reservation_areas=["Reception Pods", "Team Booths", "Open Lounge"],
            status="ACTIVE",
