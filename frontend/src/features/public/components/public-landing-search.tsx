import { Button, Container, Grid, InputAdornment, MenuItem, Paper, TextField, Typography } from '@mui/material'

import type { ReactNode } from 'react'

type PublicLandingSearchProps = {
  isLight: boolean
  location: string
  spaceType: string
  date: string
...
export const PublicLandingSearch = ({
  isLight,
  location,
  spaceType,
  date,
      ...
      <Grid container spacing={2} sx={{ alignItems: 'center' }}>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <TextField
            ...
            slotProps={{
              input: {
                startAdornment: <InputAdornment position="start">{icons.location}</InputAdornment>,
              },
            }}
          >
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <TextField
            ...
            slotProps={{
              input: {
                startAdornment: <InputAdornment position="start">{icons.spaceType}</InputAdornment>,
              },
            }}
          >
        ...
        <Grid size={{ xs: 12, sm: 6, md: 2.5 }}>
          <TextField
            ...
            slotProps={{
              ...
              input: {
                startAdornment: <InputAdornment position="start">{icons.date}</InputAdornment>,
              },
            }}
          />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 2 }}>
          <TextField
            ...
            slotProps={{
              input: {
                startAdornment: <InputAdornment position="start">{icons.capacity}</InputAdornment>,
              },
            }}
          >
